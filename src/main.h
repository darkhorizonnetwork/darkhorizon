...
static const unsigned int MAX_BLOCK_SIZE = 2000000; //1000000; // updated to 2000KB         // 1000KB block hard limit
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/4;         // 250KB  block soft limit
/** Default for -blockmaxsize, maximum size for mined blocks **/
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 500000;//250000;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 250000;//17000;
...
static const int64 DUST_SOFT_LIMIT = 10000; //0.0001 DHN (one tenth of a main mining reward unit)//old - 100000; // 0.001 DHN
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 10; //0.0000001 DHN // old = 1000;   // 0.00001 DHN mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 60000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1 / 1000; //was 576/250
    }
